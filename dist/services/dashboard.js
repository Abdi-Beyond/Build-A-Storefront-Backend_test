...
var Dashboard = /** @class */ (function () {
    ...
    Dashboard.prototype.productsinorder = function () {
        return __awaiter(this, void 0, void 0, function () {
            var query, con, result, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        query = 'SELECT * FROM products INNER JOIN order_product ON products.id = order_product.product_id';
                        return [4 /*yield*/, database_provider_1["default"].connect()];
                    case 1:
                        con = _a.sent();
                        return [4 /*yield*/, con.query(query)];
                    case 2:
                        result = _a.sent();
                        con.release();
    ...
    Dashboard.prototype.addproducttoorder = function (newproductorder) {
        return __awaiter(this, void 0, void 0, function () {
            var query1, con, result, err_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        query1 = 'INSERT INTO order_product (quantity, order_id, product_id) VALUES ($1, $2, $3) RETURNING *';
                        return [4 /*yield*/, database_provider_1["default"].connect()];
                    case 1:
                        con = _a.sent();
                        return [4 /*yield*/, con.query(query1, [newproductorder.quantity, newproductorder.order_id, newproductorder.product_id])];
                    case 2:
                        result = _a.sent();
                        con.release();
    ...
    Dashboard.prototype.deleteproductfromorder = function (order_id, product_id) {
        return __awaiter(this, void 0, void 0, function () {
            var query, query2, con, result1, result2, err_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 6, , 7]);
                    ...
                    case 1:
                        con = _a.sent();
                        return [4 /*yield*/, con.query(query, [order_id])];
                    case 2:
                        result1 = _a.sent();
                        if (!(result1.rows.length === 0)) return [3 /*break*/, 3];
                        con.release();
                        return [2 /*return*/, 'Order not found'];
                    case 3: return [4 /*yield*/, con.query(query2, [order_id, product_id])];
                    case 4:
                        result2 = _a.sent();
                        con.release();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        con = _a.sent();
                        return [4 /*yield*/, con.query(query3, [updateproorder.quantity, updateproorder.order_id, updateproorder.product_id])];
                    case 2:
                        result = _a.sent();
                        con.release();
                        return [2 /*return*/, result.rows[0]];
