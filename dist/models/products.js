...
var Product = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        query2 = 'SELECT * FROM products WHERE id=($1)';
                        return [4 /*yield*/, database_provider_1["default"].connect()];
                    case 1:
                        con = _a.sent();
    ...
    Product.prototype.create = function (newproduct) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        query3 = 'INSERT INTO products (name, price, category) VALUES ($1, $2, $3) RETURNING *';
                        return [4 /*yield*/, database_provider_1["default"].connect()];
                    case 1:
                        con = _a.sent();
    ...
    Product.prototype.update_product = function (id, newproduct) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        query4 = 'UPDATE products SET name=($1), price=($2), category=($3) WHERE id=($4) RETURNING *';
                        return [4 /*yield*/, database_provider_1["default"].connect()];
                    case 1:
                        con = _a.sent();
                    ...
                    case 2:
                        ...
                        if (result1.rows.length === 0) {
                            con.release();
                            return [2 /*return*/, 'Product does not exist'];
                        }
    ...
    Product.prototype.delete_product = function (id) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    Product.prototype.category_products = function (category) {
        return __awaiter(this, void 0, void 0, function () {
            var query6, con, result, err_6;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        query6 = 'SELECT * FROM products WHERE category=($1)';
                        return [4 /*yield*/, database_provider_1["default"].connect()];
                    case 1:
                        con = _a.sent();
                        return [4 /*yield*/, con.query(query6, [category])];
                    case 2:
                        result = _a.sent();
                        con.release();
                        return [2 /*return*/, result.rows];
    ...
    Product.prototype.popular_products = function () {
        return __awaiter(this, void 0, void 0, function () {
            var query7, con, result, err_7;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        query7 = 'SELECT * FROM orders GROUP BY product_id ORDER BY COUNT(*) DESC LIMIT 3';
                        return [4 /*yield*/, database_provider_1["default"].connect()];
                    case 1:
                        con = _a.sent();
                        return [4 /*yield*/, con.query(query7)];
                    case 2:
                        result = _a.sent();
                        con.release();
                        return [2 /*return*/, result.rows];
